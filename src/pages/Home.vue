    ...
    <template v-else>
      ...
      <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
        <StatsCard :value="stats.total.toLocaleString('pt-BR')" label="Total de participações"
          ...
          <template #icon>
            <svg width="60" height="60" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M14.833 9.66702V5.40002C16.8253 6.10729 18.3927 7.67474 19.1 9.66702H14.833Z" stroke="currentColor"
        ...
        <StatsCard :value="stats.confirmed.toLocaleString('pt-BR')" label="Total de pessoas que contribuiram"
          iconBg=" text-emerald-600">
          <template #icon><svg width="60" height="60" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
